...
if (params$target == "index") {
  cat('<iframe src="usdm.html" width="100%" height="600" style="border:none;"></iframe>')
} else {
  cat("[📂 View the US Drought Monitor archive listing](https://climate-smart-usda.github.io/usdm/)")
}
```
